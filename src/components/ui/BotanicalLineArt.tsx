...
export default function BotanicalLineArt() {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      const paths = root.querySelectorAll<SVGPathElement>(".botanical-draw");
      ...
      paths.forEach((path, index) => {
        ...
        gsap.to(path, {
          ...
          scrollTrigger: {
            ...
            scrub: 0.65 + (index % 5) * 0.08,
          },
        });
      });

      gsap.to(".botanical-layer--near", {
        yPercent: -3.5,
        ease: "none",
        scrollTrigger: {
          trigger: section,
  ...
  return (
    <div ref={rootRef} className="botanical-effect" aria-hidden="true">
      <svg viewBox="0 0 1440 3600" preserveAspectRatio="none">
        <g className="botanical-layer--near" fill="none" stroke="#3a9e3f" strokeWidth="1.5" opacity="0.3" strokeLinecap="round" strokeLinejoin="round">
        ...
        <g className="botanical-layer--far" fill="none" stroke="#004a92" strokeWidth="1.2" opacity="0.22" strokeLinecap="round" strokeLinejoin="round">
        ...
        <g className="botanical-hands" fill="none" stroke="#8b7a63" strokeWidth="1.35" opacity="0.24" strokeLinecap="round" strokeLinejoin="round">
